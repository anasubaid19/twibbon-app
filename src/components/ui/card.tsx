...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex items-center rounded-b-xl border-t bg-surface2/50 p-(--card-spacing)',
        className,
      )}
      {...props}
    />
